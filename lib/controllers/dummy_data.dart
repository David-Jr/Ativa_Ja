...
final List<Shortcut> dummyShortcutList = [
  ...
  Shortcut(
    ...
    steps: "1;2;",
    ussdCode: "*161#",
    description: "Actvar o meu número 1",
    isFavorite: RxBool(false),
    isp: dummyIspList[VODACOM],
  ),
  Shortcut(
    id: 6,
    tittle: "6mt = 130mb, credito",
    steps: "1;2;",
    ussdCode: "*111#",
    description: "Activar megas de 6 meticais de duração de uma hora",
    isFavorite: RxBool(false),
    isp: dummyIspList[VODACOM],
  ),
  Shortcut(
    id: 7,
    tittle: "5mt = 40mb, credito",
    steps: "1;2;",
    ussdCode: "*111#",
    description: "Activar megas de 5 meticais de duração de 6 horas",
    isFavorite: RxBool(false),
    isp: dummyIspList[VODACOM],
  ),
  Shortcut(
